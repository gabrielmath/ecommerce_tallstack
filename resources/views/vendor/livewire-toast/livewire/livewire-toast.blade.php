<div class="fixed z-50 bottom-4 right-4 {{--{{$positionCss}}--}} @if($hideOnClick) cursor-pointer @endif"
...
>
  @if($message)
    <div
      class="flex bg-{{$bgColorCss}}-500 border-l-4 border-{{$bgColorCss}}-700 py-3 px-4 shadow-md mb-2 items-center ">
      <!-- icons -->
      @if($showIcon)
